...
func (h *Handler) listEditableCourses(c *gin.Context) {
	rows, err := h.svc.ListEditableCourses(c.Request.Context(), currentUserID(c))
...
func (h *Handler) getCourseDetail(c *gin.Context) {
	h.courseOK(c, "ok", func(courseID uint) (any, error) {
		return h.svc.GetCourseDetail(c.Request.Context(), courseID, currentUserID(c), true)
	})
}

func (h *Handler) prepareDraft(c *gin.Context) {
	h.courseOK(c, "ok", func(courseID uint) (any, error) {
		return h.svc.PrepareDraft(c.Request.Context(), courseID, currentUserID(c))
	})
}
...
func (h *Handler) updateBasicInfo(c *gin.Context) {
	courseBodyOK(h, c, "updated", func(courseID uint, req *updateBasicInfoRequest) (any, error) {
		return h.svc.UpdateBasicInfo(c.Request.Context(), courseID, currentUserID(c), domain.UpdateBasicInfoInput{
			ActorUserID:        currentUserID(c),
...
func (h *Handler) deleteCourse(c *gin.Context) {
	withCourseID(c, func(courseID uint) {
		if err := h.svc.DeleteCourse(c.Request.Context(), courseID, currentUserID(c)); mapCourseError(c, err) {
			return
		}
...
func (h *Handler) listCollaborators(c *gin.Context) {
	h.courseOK(c, "ok", func(courseID uint) (any, error) {
		return h.svc.ListCollaborators(c.Request.Context(), courseID, currentUserID(c))
	})
}
...
func (h *Handler) addCollaborator(c *gin.Context) {
	courseBodyOK(h, c, "updated", func(courseID uint, req *addCollaboratorRequest) (any, error) {
		return h.svc.AddCollaborator(c.Request.Context(), courseID, currentUserID(c), req.UserID, req.Role)
	})
}
...
func (h *Handler) removeCollaborator(c *gin.Context) {
	h.courseParamOK(c, "userId", "invalid user id", "updated", func(courseID, userID uint) (any, error) {
		return h.svc.RemoveCollaborator(c.Request.Context(), courseID, currentUserID(c), userID)
	})
}
