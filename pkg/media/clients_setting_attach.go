...
func attachB2FromSetting(out *entities.CloudClients, ms *setting.Media) error {
	if ms == nil {
		return nil
	}
...
func attachGcoreFromSetting(out *entities.CloudClients, ms *setting.Media) {
	if ms == nil {
		return
	}
...
func attachBunnyStorageFromSetting(out *entities.CloudClients, ms *setting.Media) error {
	if ms == nil {
		return nil
	}
