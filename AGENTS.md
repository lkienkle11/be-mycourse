...
This project is indexed by GitNexus as **be-mycourse** (7849 symbols, 23198 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
