...
This project is indexed by GitNexus as **be-mycourse** (7020 symbols, 21017 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
