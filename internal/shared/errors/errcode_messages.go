...
var defaultMessages = map[int]string{
	...
	InvalidDiscordCode:      "Invalid or expired Discord authorization code",
	DiscordEmailNotVerified: "Discord account email is not verified",
	DiscordEmailUnavailable: "Discord account has no email available for sign-in",
