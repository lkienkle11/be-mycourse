...
func (h *Handler) createSection(c *gin.Context) {
	courseBodyCreated(h, c, "created", func(courseID uint, req *sectionRequest) (any, error) {
		return h.svc.CreateSection(c.Request.Context(), courseID, currentUserID(c), domain.UpsertSectionInput{
			Title:       req.Title,
...
func (h *Handler) updateSection(c *gin.Context) {
	courseParamBodyOK(h, c, "sectionId", "invalid section id", "updated", func(courseID, sectionID uint, req *sectionRequest) (any, error) {
		return h.svc.UpdateSection(c.Request.Context(), courseID, currentUserID(c), domain.UpsertSectionInput{
			SectionID:          &sectionID,
...
func (h *Handler) deleteSection(c *gin.Context) {
	h.courseParamOK(c, "sectionId", "invalid section id", "deleted", func(courseID, sectionID uint) (any, error) {
		return h.svc.DeleteSection(c.Request.Context(), courseID, currentUserID(c), sectionID)
	})
}

func (h *Handler) reorderSections(c *gin.Context) {
	courseBodyOK(h, c, "updated", func(courseID uint, req *reorderRequest) (any, error) {
		return h.svc.ReorderSections(c.Request.Context(), courseID, currentUserID(c), req.OrderedStableIDs)
	})
}
...
func (h *Handler) upsertLesson(c *gin.Context, create bool) {
	handler := func(courseID uint, lessonID *uint, req *lessonRequest) {
		...
		if create {
			row, err := h.svc.CreateLesson(c.Request.Context(), courseID, currentUserID(c), input)
		...
		row, err := h.svc.UpdateLesson(c.Request.Context(), courseID, currentUserID(c), input)
		if mapCourseError(c, err) {
			return
		}
...
func (h *Handler) deleteLesson(c *gin.Context) {
	h.courseParamOK(c, "lessonId", "invalid lesson id", "deleted", func(courseID, lessonID uint) (any, error) {
		return h.svc.DeleteLesson(c.Request.Context(), courseID, currentUserID(c), lessonID)
	})
}

func (h *Handler) reorderLessons(c *gin.Context) {
	reorderByParent(h, c, "sectionId", "invalid section id", func(courseID, sectionID uint, orderedStableIDs []string) (any, error) {
		return h.svc.ReorderLessons(c.Request.Context(), courseID, currentUserID(c), sectionID, orderedStableIDs)
	})
}
...
func (h *Handler) upsertSubLesson(c *gin.Context, create bool) {
	handler := func(courseID uint, subLessonID *uint, req *subLessonRequest) {
		...
		if create {
			row, err := h.svc.CreateSubLesson(c.Request.Context(), courseID, currentUserID(c), input)
			if mapCourseError(c, err) {
				return
			}
			response.Created(c, "created", row)
		...
		row, err := h.svc.UpdateSubLesson(c.Request.Context(), courseID, currentUserID(c), input)
		if mapCourseError(c, err) {
			return
		}
		response.OK(c, "updated", row)
...
func (h *Handler) deleteSubLesson(c *gin.Context) {
	h.courseParamOK(c, "subLessonId", "invalid sub-lesson id", "deleted", func(courseID, subLessonID uint) (any, error) {
		return h.svc.DeleteSubLesson(c.Request.Context(), courseID, currentUserID(c), subLessonID)
	})
}

func (h *Handler) reorderSubLessons(c *gin.Context) {
	reorderByParent(h, c, "lessonId", "invalid lesson id", func(courseID, lessonID uint, orderedStableIDs []string) (any, error) {
		return h.svc.ReorderSubLessons(c.Request.Context(), courseID, currentUserID(c), lessonID, orderedStableIDs)
	})
}

func (h *Handler) acquireLease(c *gin.Context) {
	courseBodyOK(h, c, "ok", func(courseID uint, req *leaseAcquireRequest) (any, error) {
		return h.svc.AcquireLease(c.Request.Context(), courseID, currentUserID(c), domain.AcquireLeaseInput{
...
func (h *Handler) heartbeatLease(c *gin.Context) {
	courseBodyOK(h, c, "ok", func(courseID uint, req *leaseHeartbeatRequest) (any, error) {
		return h.svc.HeartbeatLease(c.Request.Context(), courseID, currentUserID(c), domain.LeaseHeartbeatInput{
...
func (h *Handler) releaseLease(c *gin.Context) {
	withCourseAndBody[leaseReleaseRequest](c, func(courseID uint, req *leaseReleaseRequest) {
		if err := h.svc.ReleaseLease(c.Request.Context(), courseID, currentUserID(c), domain.ReleaseLeaseInput{
			LeaseToken: req.LeaseToken,
