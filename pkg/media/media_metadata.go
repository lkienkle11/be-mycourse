...
func typedMetadataBase(mimeType, filename string, sizeBytes int64) entities.FileMetadata {
...
func buildVideoTypedMetadata(base entities.FileMetadata, raw entities.RawMetadata) entities.UploadFileMetadata {
