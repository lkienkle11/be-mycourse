...
This project is indexed by GitNexus as **be-mycourse** (7864 symbols, 23228 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
