...
This project is indexed by GitNexus as **be-mycourse** (7670 symbols, 22587 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
