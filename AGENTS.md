...
This project is indexed by GitNexus as **be-mycourse** (7625 symbols, 22559 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
